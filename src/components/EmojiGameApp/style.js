...
const WinOrLoseContainer =  styled.div`${tw `flex justify-center items-center flex-col justify-between text-2xl font-extrabold p-3`}`
...
const PlayAgainButton = styled.div`${tw `p-3 bg-blue-700 rounded`}`
